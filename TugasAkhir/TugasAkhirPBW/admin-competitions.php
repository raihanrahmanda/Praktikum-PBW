...
<head>
    ...
    <link rel="stylesheet" href="asset/css/admin-competition-style.css">
...
<body>
    ...
    <div class="navigation">
        ...
        <div class="main">
            <div class="text">
                <h1>CatchAW Competitions List</h1>
                <p>Here is the list of competitions that has been inputted</p>
            </div>

            <div class="row-count">
            <?php
                $rowCount = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM competitions"));
                echo "Number of competitions: " . $rowCount;
            ?>
            </div>
            ...
            <div class="comps-table">
                <table>
                    ...
                    <tr>
                        <td><?php echo $i++; ?></td>
                        <td><img src="asset/image/lomba/<?php echo $row["image"]; ?>" width = 100 height=100 title="<?php echo $row['image']; ?>"></td>
                        ...
                        <td>
                            ...
                            <a href="asset/php/comp-update.php?id=<?php echo $row["id"]; ?>">
                                <ion-icon id="update" name="sync-outline"></ion-icon>
                            </a>
                            
                            <a href="asset/php/comp-delete.php?id=<?php echo $row["id"]; ?>" onclick="return confirm('Are you sure you want to delete this data?')">
