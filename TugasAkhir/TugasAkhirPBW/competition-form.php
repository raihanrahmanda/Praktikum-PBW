...
<body>
    <div class="container">
        <div class="wrapper">
            ...
            <form action="asset/php/comp-create.php" method="post" enctype="multipart/form-data">
                <div class="field">
                ...
                <div class="field">
                    <input type="text" name="guidebook-link" required>
                ...
                <div class="submit-btn">
                    <input type="submit" name="input-comp" value="Input">
                </div>
            </form>
        </div>
    </div>
