...
$query = "SELECT * FROM seminar WHERE name LIKE '%$keyword%' ORDER BY id DESC";
    ...
    $output .= '
        <div class="competition-card">
            <div class="competition-image" onclick="togglePopup(\'popup-' . $row['id'] . '\')">
                <img src="asset/image/seminar/' . $row['image'] . '" title="' . $row['image'] . '">
            </div>
            ...
            <div class="popup" id="popup-' . $row['id'] . '">
                ...
                <div class="popup-content">
                    ...
                    <div class="content-box">
                        ...
                        ' . $row['start_date'] . ' s.d ' . $row['close_date'] . ' <br>
                        <br>
...
echo '<script src="asset/js/seminar.js"></script>';
?>
